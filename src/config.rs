...
// stayed size-uniform (leaving mass_edge ~= 0 and predation with nothing to win on). intake_scale was
// already applied to eating food items (the `gape` term) and grazing was simply missed.
